...
public class GraficaEurodollarEjemplo extends ApplicationFrame {
	...
	private static final BasicStroke DOTTED_LINE = new BasicStroke(WIDTH,
			BasicStroke.CAP_ROUND, BasicStroke.JOIN_ROUND, 1.0f, new float[] {
					FIRST_LINE_LENGTH, SECOND_LINE_LENGTH }, 0.0f);
	...
	public static JFreeChart createChart() {
		...
		JFreeChart chart = ChartFactory.createTimeSeriesChart(title, "Fecha",
				"WUL", createPriceDataset("WUL"), true, true, false);
...
//		XYDataset dataset1 = createPriceDataset(pNombreAxis);
	 ...
	 */
	private static XYDataset createPriceDataset(String pNombreSerie) {

		// create dataset 1...
		TimeSeries series1 = new TimeSeries(pNombreSerie, Day.class);
	 ...
	 * @return A sample dataset.
	 */
	private static XYDataset createVolumeDataset(String pNombreSerie) {
	...
	public static void main(String[] args) {
		...
		GraficaEurodollarEjemplo demo = new GraficaEurodollarEjemplo(
