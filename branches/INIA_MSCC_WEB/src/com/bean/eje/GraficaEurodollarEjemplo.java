...
*/
public class GraficaEurodollarEjemplo extends ApplicationFrame {
    ...
    private static final BasicStroke DOTTED_LINE = new BasicStroke(WIDTH, BasicStroke.CAP_ROUND,
            BasicStroke.JOIN_ROUND, 1.0f, new float[] { FIRST_LINE_LENGTH, SECOND_LINE_LENGTH }, 0.0f);
     ...
     */
    public GraficaEurodollarEjemplo(String title) {
    ...
    public static JFreeChart createChart() {
        ...
        XYDataset volumeData = createVolumeDataset();
...
//        Date sampleDate = DateUtilities.createDate(2002,MonthConstants.MAY,1);
//
...
//        radius[0] = 3;
//        
//        OpusXYZDataset intervalData = new OpusXYZDataset(xValue,yStart,radius);
        
        
        //CircleShapeItemRenderer renderer = new CircleShapeItemRenderer(31.0f,new StandardXYToolTipGenerator());
//        XYBubbleRenderer renderer = new XYBubbleRenderer(0);
//        renderer.setSeriesPaint(1,new Color(0,255,0,118));
...
//        plot.setRenderer(1,renderer);
		...
		XYBarRenderer renderer2 = new XYBarRenderer(0);
		renderer2.setSeriesPaint(1,new Color(0,255,0,118));
    ...
    public static void main(String[] args) {
    	...
    	GraficaEurodollarEjemplo demo = new GraficaEurodollarEjemplo("Price Volume Chart Demo");
        demo.pack();
