...
public abstract class GraficaEurodollar  implements Serializable {
	...
	private static XYDataset createPriceDataset(String pNombreSerie) {
		...
		TimeSeriesCollection coleccionSeries = new TimeSeriesCollection(series1);
		series1 = new TimeSeries("WLL", Day.class);
		...
		coleccionSeries.getSeries(0).setDescription("asdfas");
		coleccionSeries.getSeries(1).setDescription("asdfas2");
