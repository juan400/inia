...
*/
public class GraficaEurodollar extends ApplicationFrame {
     ...
     */
    public GraficaEurodollar(String title) {
    ...
    private static JFreeChart createChart() {
        ...
        //CircleShapeItemRenderer renderer = new CircleShapeItemRenderer(131.0f,new StandardXYToolTipGenerator());
    ...
    public static void main(String[] args) {
    	...
    	GraficaEurodollar demo = new GraficaEurodollar("Price Volume Chart Demo");
        demo.pack();
