...
public abstract class Graficador implements Serializable {
	 ...
	 * @return a chart.
	 */
	public static JFreeChart createTipoEurodollar(
	...
	public static JFreeChart createTipoXYSpline(String pTituloGrafica, Map<String, ArrayList> pDatos,
...
//		 AXIS 0
		...
		for (int i = 0; i < columnas.length; i++) {
			...
			cargarPlot(crearDataset(pDatos, columnas[i]), linea, i, columnas[i], plot, Color.BLUE,
					AxisLocation.BOTTOM_OR_LEFT);
		}
//		XYSplineRenderer linea =new XYSplineRenderer();
//		linea.setShapesVisible(false);
//		cargarPlot(crearDataset(pDatos, "CSH"), linea, 0, "CSH", plot, Color.BLUE,
//				AxisLocation.BOTTOM_OR_LEFT);
////		 AXIS 1
//		linea =new XYSplineRenderer();
//		linea.setShapesVisible(false);
//		cargarPlot(crearDataset(pDatos, "LAI"), linea, 1, "LAI", plot, Color.RED,
//				AxisLocation.BOTTOM_OR_LEFT);
