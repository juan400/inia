...
<f:subview id="login">
	...
	<h:form>
		...
		<h:panelGrid headerClass="tituloPantalla">
				...
				<h:outputText styleClass="mensajeError" value="#{text.login_alreadyLogged}"/>
                <h:commandLink styleClass="textoPlano" action="#{loginBean.logout}" value="#{text.login_logout}"/>
			</h:panelGrid>
			<h:panelGroup rendered="#{!loginBean.logged}">
				<h:panelGrid columns="2" columnClasses="tituloTabla, textoPlano">
					...
					<h:panelGrid columns="2">
	                    <h:commandLink styleClass="textoPlano" action="#{loginBean.login}" value="#{text.login_login}"/>
	                    <h:commandLink styleClass="textoPlano" action="#{loginBean.registrarse}" value="#{text.login_register}"/>
					</h:panelGrid>
