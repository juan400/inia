...
<f:view>
	<h:form>
		...
		<table align="center" width="956px">
			...
			<tbody>
				<tr>
					<td align="center" class="contenido"><h:panelGroup rendered="#{loginBean.init}" />
					<h:panelGrid>
						<rich:panel headerClass="tituloPantalla" style="background-color: #ebf3fd;">
							<f:facet name="header">
							...
							<h:panelGrid rendered="#{loginBean.logged}">
								...
								<a4j:commandButton action="#{loginBean.logout}"
									value="#{text.login_logout}" />
							</h:panelGrid>
							<h:panelGroup rendered="#{!loginBean.logged}">
								<h:panelGrid columns="2" width="300">

									<h:outputText value="#{text.login_userName}" styleClass="textoPlano"/>
									<h:inputText value="#{loginBean.loginName}" styleClass="textoPlano"/>

									<h:outputText value="#{text.login_password}" styleClass="textoPlano"/>
									<h:inputSecret value="#{loginBean.password}" styleClass="textoPlano"/>

									<h:outputText value="" />
									<h:panelGrid columns="2">
										<a4j:commandButton style="font-size: 10pt; color: #2d77c2;" styleClass="textoPlano"
