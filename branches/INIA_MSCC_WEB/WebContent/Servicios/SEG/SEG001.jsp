					...
					<td align="center" class="contenido"><a4j:region
						...
						<h:panelGrid>
							<rich:panel headerClass="tituloPantalla"
								...
								<f:facet name="header">
									<h:outputText value="#{text.login_Titulo}" />
								</f:facet>
								<h:panelGrid>
									...
									<h:panelGroup rendered="#{!loginBean.logged}">
										<center><h:panelGrid columns="2" width="300">

											<h:outputText value="#{text.login_NombreUsuario}"
										...
										<center><a4j:commandLink
											action="#{loginBean.olvidoContrasenia}" immediate="true"
